...
{
    /// <inheritdoc />
    public partial class Appliance_Customer_Part_Order : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppliancePart", x => new { x.AppliancesId, x.PartsId });
                    table.ForeignKey(
                        name: "FK_AppliancePart_Appliances_AppliancesId",
                        column: x => x.AppliancesId,
                        principalTable: "Appliances",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppliancePart_Parts_PartsId",
                        column: x => x.PartsId,
